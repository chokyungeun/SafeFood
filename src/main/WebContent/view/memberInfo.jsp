...
<h1>마이 페이지<img width="50px" height="50px" src="img/animat-customize-color.gif"></h1>
<p>개인 정보를 수정 해주세요.</p>
<hr>

<label for="id"><b>사용자 ID</b></label>
<input type="text" placeholder="${m.id }" name="id" required disabled="disabled">

<label for="pass"><b>비밀 번호</b></label>
...
<label for="phone"><b>전화 번호</b></label>
...
<label for="allergy"><b>알러지 정보</b></label><br><br>
<span>
				...
				<br><br>
<div class="clearfix">
<button type="submit" class="signupbtn" style="font-family:'Sunflower', sans-serif;" >수정완료</button>
<button type="button" class="cancelbtn" onclick="location.href='main.food' " style="font-family:'Sunflower', sans-serif;">취 소</button>
</div>
<div>
   	 <button type="button" class="signupbtn2" onclick = "location.href='delete.food' " style="font-family:'Sunflower', sans-serif;">회원탈퇴</a></button>
    </div>
</div>
</form>
</div>
