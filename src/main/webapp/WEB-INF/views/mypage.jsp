          ...
          <div class="mx-auto">
            <nav class="site-navigation position-relative text-left" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none pl-0 d-lg-block border-none">
                <li><a href="main.html" class="btn btn-outline-success">&nbsp 홈 화면</a></li>
                <li><a href="notice.html" class="btn btn-outline-success">공지사항</a></li>
                <li><a href="shop.html" class="btn btn-outline-success">상품정보</a></li>
                <li><a href="best.html" class="btn btn-outline-success">베스트식품</a></li>
                <li><a href="cart.html" class="btn btn-outline-success">섭취정보</a></li>
              </ul>                                                                                                                                                                                                                                                                                         
            </nav>
          ...
          <div class="col-12">
            <div class="copyright">
                <p>
                    ...
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script>This site is made with </i> by <a href="#" target="_blank" >원석_희준</a>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </p>
