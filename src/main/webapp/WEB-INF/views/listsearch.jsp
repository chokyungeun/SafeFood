...
<center>
		...
		<form method="post" action="listsearch.food" style="font-family: 'Sunflower', sans-serif;">
			...
			<input type="submit" value="검색" style="background-color: white; border-radius: 10px; font-family: 'Sunflower', sans-serif; border-color:#ffeded; width: 100px; height: 30px"/>
		</form>
		<br><br>
		...
		<th width=100 bgcolor=#ffeded><font color=#000000 size=2>글쓴이</th>
		<th width=150 bgcolor=#ffeded><font color=#000000 size=2>날짜</th>
		<th width=100 bgcolor=#ffeded><font color=#000000 size=2>조회수</th>
